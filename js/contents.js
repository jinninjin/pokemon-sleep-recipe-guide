...
const RECIPE_NAMES = {
    ...
    recipe115:{name:"ニンジャカレー", ingredients:{daizu:15, meat:9, negi:9, kinoko:5}, sum:38},
    ...
    recipe217:{name:"ニンジャサラダ", ingredients:{daizu:15, kinoko:12, negi:15, ginger:11}, sum:53},
