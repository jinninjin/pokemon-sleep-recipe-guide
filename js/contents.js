...
const RECIPE_NAMES = {
    ...
    recipe113:{name:"おやこあいカレー", ingredients:{mitsu:12, ringo:11, egg:8, potato:4}, sum:35},
    recipe114:{name:"からくちネギもりカレー", ingredients:{negi:14, ginger:10, herv:8}, sum:32},
    recipe115:{name:"ニンジャカレー", ingredients:{daizu:24, meat:9, negi:12, kinoko:5}, sum:50},
    recipe116:{name:"あぶりテールカレー", ingredients:{sippo:8, herv:25}, sum:33},
    ...
    recipe206:{name:"うるおいとうふサラダ", ingredients:{daizu:15, tomato:9}, sum:24},
    ...
    recipe211:{name:"ばかぢからワイルドサラダ", ingredients:{meat:9, ginger:6, egg:5, potato:3}, sum:23},
    recipe212:{name:"ムラっけチョコミートサラダ", ingredients:{cacao:14, meat:9}, sum:23},
    recipe213:{name:"くいしんぼうポテトサラダ", ingredients:{potato:14, egg:9, meat:7, ringo:6}, sum:36},
    ...
    recipe216:{name:"ヤドンテールのペッパーサラダ", ingredients:{sippo:10, herv:10, oil:15}, sum:35},
    recipe217:{name:"ニンジャサラダ", ingredients:{daizu:19, kinoko:12, negi:15, ginger:11}, sum:57},
    ...
    recipe312:{name:"ちからもちソイドーナッツ", ingredients:{oil:12, daizu:16, cacao:7}, sum:35},
